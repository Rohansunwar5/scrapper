...
chromium_path = "/usr/bin/chromium"  # Corrected the path variable name
...
async def scrape_page(browser, search_query, page_num, retries=3):
    page = await browser.newPage()
    await page.setUserAgent(random.choice(USER_AGENTS))

    # Optional: Add more headers to randomize
...
async def home():
    print("working 2")
    return jsonify("HELLO FROM GENERIC Search of telemetr")
